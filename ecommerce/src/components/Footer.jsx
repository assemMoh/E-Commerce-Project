                ...
                <div className="row ">
                    ...
                    <div className="col ms-5">
                        ...
                        <ul className='list-unstyled text-light'>
                            <li>+(20)1111111111</li>
                            <li>Cairo, Egypt</li>
                            <li>123 Lorem Street, North Cairo</li>
                        </ul>
                    </div>
                    {/* column 2 */}
                    <div className="col ms-5">
                    ...
                    <div className="col ms-5 ">
                        ...
                        <ul className='list-unstyled container'>
                            <div className="row">
                                ...
                                <li className='mt-3'>
                                    <a href="https://www.twitter.com" target='_blank' style={{ textDecoration: 'none', color: 'white' }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" className="bi bi-twitter" viewBox="0 0 16 16">
